  ...
  tagList(
    tabBoxPrmdt(
      ...
      tabPanel(title = p(labelInput("seleParModel"),class = "wrapper-tag"), value = "tabCVrfModelo",
               ...
               fluidRow(col_6(numericInput(ns("cvrf_step"), labelInput("probC"), value = 0.5, width = "100%", min = 0, max = 1, step = 0.1)),
      ...
      tabPanel(title = p(labelInput("indicesCat"),class = "wrapper-tag"), value = "tabCVrfIndicesCat",
               ...
               div(col_6(echarts4rOutput(ns("e_rf_category"), width = "100%", height = "70vh")), 
                   col_6(echarts4rOutput(ns("e_rf_category_err"), width = "100%", height = "70vh"))))
    )
